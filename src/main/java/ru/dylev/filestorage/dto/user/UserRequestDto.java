...
import ru.dylev.filestorage.dto.validation.groups.OnCreate;
import ru.dylev.filestorage.dto.validation.groups.OnPasswordUpdate;
import ru.dylev.filestorage.dto.validation.groups.OnUpdate;

import java.io.Serializable;

/**
 * Class represents {@link ru.dylev.filestorage.entity.User} data, which is received with HTTP request.
 */
@Data
